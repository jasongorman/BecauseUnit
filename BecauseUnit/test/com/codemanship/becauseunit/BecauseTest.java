...
public class BecauseTest extends TestMother {
	...
	public void becauseInitialisedWithTestMethod() throws NoSuchMethodException, SecurityException{
		Test test = testMother.createTest("becauseInitialisedWithTestMethod", BecauseTest.class, this);
		check(test.getName().equals("com.codemanship.becauseunit.BecauseTest::becauseInitialisedWithTestMethod") );
	}
	...
	private Test runTest(String testMethodName) throws NoSuchMethodException {
		test = testMother.createTest(testMethodName, BecauseTest.class, this);
