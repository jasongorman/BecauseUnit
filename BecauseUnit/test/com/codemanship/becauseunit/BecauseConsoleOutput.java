...
public class BecauseConsoleOutput {
	...
	public void becauseResultIncludesTestName() throws NoSuchMethodException{
		runTest("passingTest");
		check(writer.getLastWrite().contains("com.codemanship.becauseunit.BecauseConsoleOutput::passingTest"));
	}
	...
	private Test runTest(String testMethodName) throws NoSuchMethodException {
		...
		Output output = new ConsoleOutput(writer);
		Test test = new TestMother().createTest(testMethodName, this.getClass(), this);
		test.run(output);
		return test;
	}
